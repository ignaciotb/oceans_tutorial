...
\title{\normalfont\spacedallcaps{Yet another simulator for underwater vehicles}} % The article title

%\subtitle{Subtitle} % Uncomment to display a subtitle

\author{Nils Bore, Ignacio Torroba \& John Folkesson\\
\{nbore, torroba, johnf\}@kth.se} % The article author(s) - author affiliations need to be specified in the AUTHOR AFFILIATIONS block
